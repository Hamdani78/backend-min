    ...
    <div class="p-4">
      ...
      <div v-if="pendaftar">
        <div class="bg-white p-4 rounded shadow max-w-xl">
          ...
          <img v-if="pendaftar.foto" :src="`/storage/${pendaftar.foto}`" alt="Foto Pendaftar"
      ...
      <div v-if="berkas" class="bg-white p-4 rounded shadow max-w-xl mt-4">
        ...
        <ul class="list-disc list-inside text-sm text-gray-700">
          <li v-if="berkas.ijazah_tk">Ijazah TK: <a :href="`/storage/${berkas.ijazah_tk}`"
              class="text-blue-600 underline" target="_blank">Lihat</a></li>
          ...
          <li v-if="berkas.kartu_keluarga">Kartu Keluarga: <a :href="`/storage/${berkas.kartu_keluarga}`"
              class="text-blue-600 underline" target="_blank">Lihat</a></li>
          <li v-if="berkas.kip">KIP: <a :href="`/storage/${berkas.kip}`" class="text-blue-600 underline"
              target="_blank">Lihat</a></li>
        </ul>
      </div>
      <div v-if="pendaftar?.daftar_ulang?.file_surat">
      ...
      <div class="mt-4">
        ...
        <template v-else-if="statusPendaftaran === 'selesai'">
          <p class="text-green-600 font-semibold text-lg">Pendaftaran Anda telah selesai! Selamat!</p>
        </template>
      </div>
    </div>
  </UserLayout>
