<template>
    <UserLayout>
        <div class="max-w-5xl mx-auto bg-white p-6 rounded shadow">
            <h2 class="text-xl font-bold mb-4">Data Pendaftaran Saya</h2>
            ...
            <button @click="goToEditPage" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">
                Edit Data
            </button>
        </div>
    </UserLayout>
...
function goToEditPage() {
    router.visit(route('user.pendaftaran.edit'))
}
...
const jenisKelamin = props.pendaftar.jenis_kelamin === 'L'
    ? 'Laki-laki'
    : props.pendaftar.jenis_kelamin === 'P'
        ? 'Perempuan'
        : '-'
</script>
